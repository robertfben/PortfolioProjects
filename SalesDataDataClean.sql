...
-- Renaming Columns for Better Ease of Understanding



exec sp_rename 'SalesData.id' , 'SubscriptionID' , 'COLUMN'

exec sp_rename 'SalesData.DateCreated' , 'SubscriptionStartDate' , 'COLUMN'

exec sp_rename 'SalesData.DateRemoved' , 'SubscriptionEndDate' , 'COLUMN'

exec sp_rename 'SalesData.user_id' , 'CustomerID' , 'COLUMN'

exec sp_rename 'SalesData.quantity' , 'DifferentItemsSubscribedTo' , 'COLUMN'


-----------------------------------------------------------------------------------------------------

-- Permanently Creating New Table from Two Seperately-Joined Tables
